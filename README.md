...
<div align="center"> 🚀 Welcome to my git repo :LangChain-Spotify-Playlist-Creator:</div>

### LangChain-Spotify-Playlist-Creator 
<img src="https://github.com/himalayaashish/LangChain-Spotify-Playlist-Creator/blob/main/81.png?raw=true" alt="Lumbar Detection" width="500"/>


#### LangChain Spotify Playlist Creator
###### This project focuses on building a conversational agent that allows users to interact with Spotify api using natural language. By leveraging LangChain for orchestrating conversations and OpenAI's LLMs (Large Language Models), the system enables intelligent querying and summarization of PDF content.
